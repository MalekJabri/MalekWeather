 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__162CC011_450B48_4545AB_45ACE3_45AEBA3D04EBEB;
...
@Path("/Malek-Weather-Advice")
public class Malek_45Weather_45AdviceResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_162CC011-0B48-45AB-ACE3-AEBA3D04EBEB", "Malek-Weather-Advice");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_162CC011-0B48-45AB-ACE3-AEBA3D04EBEB", "Malek-Weather-Advice", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("Malek-Weather-Advice") + ".dmn_nologic")));
    }
